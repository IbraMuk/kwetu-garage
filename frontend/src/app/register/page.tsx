    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-white flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-slate-900 p-12 relative z-10">
            <div className="mb-12">
              <Logo
                width={128}
                height={128}
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center space-x-8 pt-4">
                <div className="text-center">
                  <Lock className="h-10 w-10 text-blue-500/80 mx-auto mb-2" />
                  <p className="text-sm text-slate-500">Données cryptées</p>
                </div>
                <div className="text-center">
                  <Wrench className="h-10 w-10 text-blue-500/80 mx-auto mb-2" />
                  <p className="text-sm text-slate-500">Support technique</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-slate-300 placeholder-slate-400 text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
                    placeholder="Jean"
                  />
                  {errors.first_name && (
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    type="email"
                    autoComplete="email"
                    className="w-full px-4 py-3 pl-12 bg-white border border-slate-300 placeholder-slate-400 text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 pl-12 pr-12 bg-white border border-slate-300 placeholder-slate-400 text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
