...
const navigation = [
  ...
  { name: "Mécaniciens", href: "/mechanics", icon: UserCog },
  { name: "Commandes", href: "/orders", icon: ShoppingCart },
  { name: "Dépannage", href: "/assistance", icon: LifeBuoy },
...
const pageTitles: Record<string, { title: string; subtitle?: string }> = {
  ...
  "/mechanics": { title: "Mécaniciens", subtitle: "Gestion de l'équipe technique" },
  "/orders": { title: "Commandes", subtitle: "Commandes de pièces" },
  "/assistance": { title: "Dépannage", subtitle: "Demandes d'assistance" },
