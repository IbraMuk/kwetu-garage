            ...
            <div className="flex items-center gap-3">
              <div className="relative hidden sm:block">
                ...
                <input
                  ...
                  className="w-48 rounded-xl border border-white/20 bg-white/10 py-2.5 pl-10 pr-4 text-sm font-medium text-white placeholder-gray-500 backdrop-blur transition-all focus:border-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500/30 lg:w-64"
                />
              </div>
              <button
                type="button"
